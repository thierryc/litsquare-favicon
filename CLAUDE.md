...
2. Duplicate or create a project Figma file from the `litsquare favicon` community scaffold, replace the scaffold visuals with the project artwork, then export SVG frames from that project file into `litsquare-favicon/source`: https://www.figma.com/community/file/1650255256777018269
